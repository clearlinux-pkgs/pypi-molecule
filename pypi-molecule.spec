...
Source0  : https://files.pythonhosted.org/packages/45/e0/18c5b853be933b9704a21f376c9eda597b8f478a481187a52fba91791194/molecule-4.0.0.tar.gz
...
%prep
%setup -q -n molecule-4.0.0
cd %{_builddir}/molecule-4.0.0
pushd ..
cp -a molecule-4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656388847
...
cp %{_builddir}/molecule-4.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-molecule/82314adfc4f5f364b3443f5df8a3393fd2121964
