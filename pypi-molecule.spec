...
Source0  : https://files.pythonhosted.org/packages/3f/eb/d5c4c50ec5c2e80fa38ae90b7c3c7c582cd8f594c17b34793137c381d204/molecule-24.2.0.tar.gz
...
%prep
%setup -q -n molecule-24.2.0
cd %{_builddir}/molecule-24.2.0
pushd ..
cp -a molecule-24.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707499204
