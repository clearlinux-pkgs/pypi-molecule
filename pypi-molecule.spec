...
Source0  : https://files.pythonhosted.org/packages/7e/bd/3a9d05a1c5acdcb8da0fd7e9a0f8d8a68f4f450f194a327d4c2f8fb7e8ac/molecule-24.7.0.tar.gz
...
%prep
%setup -q -n molecule-24.7.0
cd %{_builddir}/molecule-24.7.0
pushd ..
cp -a molecule-24.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720643579
