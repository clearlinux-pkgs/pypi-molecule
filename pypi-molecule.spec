...
Source0  : https://files.pythonhosted.org/packages/dc/72/1c30d07b90b56c0521abaf999e14daf75ae493405d3ee91171fed15b75ae/molecule-24.9.0.tar.gz
...
%prep
%setup -q -n molecule-24.9.0
cd %{_builddir}/molecule-24.9.0
pushd ..
cp -a molecule-24.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726129287
