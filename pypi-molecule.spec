...
Source0  : https://files.pythonhosted.org/packages/57/bc/a6dcfca6e4cae04fdb4fc385bda0bc637a338b6d72dea79ba93eaa68e1d3/molecule-24.12.0.tar.gz
...
%prep
%setup -q -n molecule-24.12.0
cd %{_builddir}/molecule-24.12.0
pushd ..
cp -a molecule-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735097139
