...
Source0  : https://files.pythonhosted.org/packages/dd/a3/032f56c1bec7550bea1650dc5eeb4a2d027e416f93a7a854a35cff29cbfd/molecule-24.2.1.tar.gz
...
%prep
%setup -q -n molecule-24.2.1
cd %{_builddir}/molecule-24.2.1
pushd ..
cp -a molecule-24.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712764595
