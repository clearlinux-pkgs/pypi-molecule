...
Source0  : https://files.pythonhosted.org/packages/d6/fe/de492105b3d8973c82231bad57a6468c8ca4d1eaae2a2a93edd7725fbc1b/molecule-25.3.1.tar.gz
...
%prep
%setup -q -n molecule-25.3.1
cd %{_builddir}/molecule-25.3.1
pushd ..
cp -a molecule-25.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739976862
