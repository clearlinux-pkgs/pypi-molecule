...
Source0  : https://files.pythonhosted.org/packages/84/a5/6a061c6d128a351ae884133162104aa3488ac74506c36221599d95b6d33d/molecule-25.6.0.tar.gz
...
%prep
%setup -q -n molecule-25.6.0
cd %{_builddir}/molecule-25.6.0
pushd ..
cp -a molecule-25.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750433253
