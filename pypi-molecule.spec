...
Source0  : https://files.pythonhosted.org/packages/51/9e/ec0b8b286d52abe53ecb5fd3774e05098095ba05e6c49fbfab778714d97e/molecule-24.6.1.tar.gz
...
%prep
%setup -q -n molecule-24.6.1
cd %{_builddir}/molecule-24.6.1
pushd ..
cp -a molecule-24.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720196288
