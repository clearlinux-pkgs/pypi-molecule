...
Source0  : https://files.pythonhosted.org/packages/a2/01/ebbe0ace407b82439abde26c987d477b3b116776ddf554fec1a1b3542597/molecule-24.8.0.tar.gz
...
%prep
%setup -q -n molecule-24.8.0
cd %{_builddir}/molecule-24.8.0
pushd ..
cp -a molecule-24.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724082636
