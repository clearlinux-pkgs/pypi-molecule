...
Source0  : https://files.pythonhosted.org/packages/51/d8/3b029e082247fc988fa9869edf39dd3188d929db19f47e91181dff907db5/molecule-25.5.0.tar.gz
...
%prep
%setup -q -n molecule-25.5.0
cd %{_builddir}/molecule-25.5.0
pushd ..
cp -a molecule-25.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748356080
