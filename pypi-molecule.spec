...
Source0  : https://files.pythonhosted.org/packages/59/ad/303a000ff2e2ae9b0cf5300c37d79e7058607f16d9b1c667088d666c32e4/molecule-24.6.0.tar.gz
...
%prep
%setup -q -n molecule-24.6.0
cd %{_builddir}/molecule-24.6.0
pushd ..
cp -a molecule-24.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717696098
